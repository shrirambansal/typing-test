words = [
  ...
  'ball', 'bank', 'bar', 'base', 'be', 'beat', 'beautiful', 'because',
  ...
  'drug', 'during', 'each', 'early', 'east', 'easy', 'eat', 'economic',
  ...
  'happen', 'happy', 'hard', 'have', 'he', 'head', 'health', 'hear', 'heart',
  'heat', 'heavy', 'help', 'her', 'here', 'herself', 'high', 'him', 'himself',
  'his', 'history', 'hit', 'hold', 'home', 'hope', 'hospital', 'hot', 'hotel',
  ...
  'investment', 'involve', 'issue', 'it', 'item', 'its', 'itself', 'job',
  ...
  'may', 'maybe', 'me', 'mean', 'measure', 'media', 'medical', 'meet',
  'meeting', 'member', 'memory', 'mention', 'message', 'method', 'middle',
  'might', 'military', 'million', 'mind', 'minute', 'miss', 'mission', 'model',
  ...
  'notice', 'now', 'number', 'occur', 'off', 'offer', 'office', 'officer',
  'official', 'often', 'oil', 'old', 'on', 'once', 'one', 'only', 'onto',
  'open', 'operation', 'opportunity', 'option', 'or', 'order', 'organization',
  'other', 'our', 'out', 'outside', 'over', 'own', 'owner', 'page', 'pain',
  ...
  'period', 'person', 'personal', 'phone', 'political', 'politics', 'poor',
  'popular', 'population', 'position', 'positive', 'possible', 'power',
  'quite', 'race', 'radio', 'raise', 'range', 'rate', 'rather', 'reach',
  'read', 'ready', 'real', 'reality', 'realize', 'really', 'reason', 'receive',
  ...
  'resource', 'respond', 'response', 'responsibility', 'run', 'safe', 'same',
  ...
  'set', 'seven', 'several', 'shake', 'share', 'she', 'shoot', 'short', 'shot',
  ...
  'sometimes', 'speech', 'spend', 'sport', 'spring', 'staff', 'stage', 'stand',
  ...
  'test', 'than', 'thank', 'thing', 'think', 'third', 'this', 'those',
  ...
  'truth', 'try', 'turn', 'TV', 'two', 'type', 'under', 'understand', 'unit',
  'until', 'up', 'upon', 'us', 'use', 'usually', 'value', 'various', 'very',
  'victim', 'view', 'violence', 'visit', 'voice', 'vote', 'wait', 'weapon',
  'wear', 'week', 'weight', 'well', 'west', 'western', 'what', 'whatever',
  'when', 'where', 'whether', 'whose', 'why', 'wide', 'wife', 'will', 'win',
  'wind', 'window', 'wish', 'with', 'within', 'without', 'woman', 'wonder',
  'word', 'work', 'worker', 'world', 'worry', 'would', 'write', 'writer',
  'wrong', 'yard', 'yeah', 'year', 'yes', 'yet', 'you', 'young', 'your',
  'yourself'
]
...
Start = Tk()
Start.geometry('1000x600')
Start.title('Typing Test By SRB')
...
def mov_text():
  global count1, mov_words
  floatingtext = 'Typing Test By DataFlair'
  if count1 >= len(floatingtext):
    count1 = 0
    mov_words = ''
  mov_words += floatingtext[count1]
  count1 += 1
  fontlabel.configure(text=mov_words)
  fontlabel.after(150, mov_text)
...
def giventime():
  ...
  if time > 0:
    ...
    rr = messagebox.askretrycancel('Notification',
...
random.shuffle(words)
labelforward = Label(Start,
                     text=words[0],
                     font=('arial', 45, 'italic bold'),
                     fg='green')
labelforward.place(x=250, y=240)

scorelabel = Label(Start,
                   text='Your Score:',
                   font=('arial', 25, 'italic bold'),
                   fg='red')
scorelabel.place(x=10, y=100)

scorelabelcount = Label(Start,
                        text=score,
                        font=('arial', 25, 'italic bold'),
                        fg='blue')
scorelabelcount.place(x=150, y=180)

labelfortimer = Label(Start,
                      text='Time Left:',
                      font=('arial', 25, 'italic bold'),
                      fg='red')
labelfortimer.place(x=600, y=100)

timercount = Label(Start,
                   text=time,
                   font=('arial', 25, 'italic bold'),
                   fg='blue')
timercount.place(x=600, y=180)

gameinstruction = Label(Start,
                        text='Hit enter button after typing the word',
                        font=('arial', 25, 'italic bold'),
                        fg='grey')
gameinstruction.place(x=150, y=500)

wordentry = Entry(Start,
                  font=('arial', 25, 'italic bold'),
                  bd=10,
                  justify='center')
